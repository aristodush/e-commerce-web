					...
					if($extension == 'jpg'||$extension == 'png'||$extension == 'gif' )
					{
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update counter set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',address='$_POST[address]',image='$fnew' where rs_id='$_GET[res_upd]' ";  // store the submited data ino the database :images												mysqli_query($db, $sql);
													mysqli_query($db, $sql);
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Update counter</h4>

                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                       <?php $ssql ="select * from counter where rs_id='$_GET[res_upd]'";
