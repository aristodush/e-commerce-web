...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="beers.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite beverage</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from counter where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);

										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/beer.jpeg" >
                <div class="profile" style="colors:#000; font-weight:900;">
                    <div class="container">
                        <div class="row" >
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/Res_img/'.$rows['image'].'" alt="counter logo">'; ?></figure>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rwf 1,000</a> </li>
...
?>
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              POPULAR ORDERS  Cold beverage! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of beverage/beers
									$stmt = $db->prepare("select * from beers where rs_id='$_GET[res_id]'");
									$stmt->execute();
